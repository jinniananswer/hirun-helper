layui.extend({
    ...
    var stopEmployeeContract = {
        init: function () {
            ...
            form.on('submit(stop-employeeContract-submit)', function (data) {
                var field = data.field; //获取提交的字段
                var index = parent.layer.getFrameIndex(window.name);
                $.ajax({
                    url: 'api/organization/employee-contract/stopEmployeeContract',
                    type: 'POST',
                    data: field,
    ...
    exports('stopEmployeeContract', stopEmployeeContract);
});