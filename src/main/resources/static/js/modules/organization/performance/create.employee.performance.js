layui.extend({
    ...
    var createEmployeePerformance = {
        init: function () {
            ...
            form.on('submit(add-employeePerformance-submit)', function (data) {
                var field = data.field; //获取提交的字段
                var index = parent.layer.getFrameIndex(window.name);
                $.ajax({
                    url: 'api/organization/employee-performance/addEmployeePerformance',
                    type: 'POST',
                    data: field,
