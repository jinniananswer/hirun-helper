layui.extend({}).define(['ajax', 'form', 'layer', 'element', 'laydate', 'select'], function (exports) {
    ...
    var createEmployeeHoliday = {
        init: function () {

            layui.select.init('holidayType', 'HOLIDAY_TYPE', '', true);
            layui.select.init('isSurrenderInsurance', 'YES_NO', '', true);
            ...
            form.on('submit(add-employeeholiday-submit)', function (data) {
    ...
    exports('createEmployeeHoliday', createEmployeeHoliday);
});