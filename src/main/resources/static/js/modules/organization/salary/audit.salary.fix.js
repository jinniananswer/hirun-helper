require(['vue','ELEMENT','ajax', 'vxe-table', 'vueselect', 'org-orgtree', 'util'], function(Vue, element, ajax, table, vueSelect, orgTree, util) {
    ...
    let vm = new Vue({
        ...
        methods: {
            query: function() {
                let that = this;
                ajax.get('api/organization/employee-salary-fix/queryAuditFixSalary', this.queryCond, function(data){
                    that.employees = data;
                });
            },

            auditPass : function() {
                ajax.post('api/organization/employee-salary-fix/auditPass', this.$refs.employeeSalary.getCheckboxRecords());
            },
            ...
            confirmAuditNoReason: function() {
                ...
                if (salaries && salaries.length > 0) {
                    ...
                    ajax.post('api/organization/employee-salary-fix/auditNo', this.$refs.employeeSalary.getCheckboxRecords());
                }
