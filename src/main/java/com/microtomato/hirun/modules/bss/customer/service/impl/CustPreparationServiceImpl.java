...
public class CustPreparationServiceImpl extends ServiceImpl<CustPreparationMapper, CustPreparation> implements ICustPreparationService {
    ...
    @Override
    public List<CustPreparationDTO> queryCustPreparaton(String mobileNo, Long custId, String status, String houseId, String isExpire) {
        ...
        queryWrapper.eq(StringUtils.isNotEmpty(houseId), "b.house_id", houseId);
        //2表示需要判断未过失效期
