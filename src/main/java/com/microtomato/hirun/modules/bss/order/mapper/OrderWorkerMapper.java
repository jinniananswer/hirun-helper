...
public interface OrderWorkerMapper extends BaseMapper<OrderWorker> {
    ...
    @Select("select a.id, a.order_id, b.employee_id, a.role_id, a.start_date, a.end_date, b.name, b.status, c.role_name from order_worker a, ins_employee b, ins_role c where b.employee_id = a.employee_id and c.role_id = a.role_id and a.order_id = #{orderId}")
