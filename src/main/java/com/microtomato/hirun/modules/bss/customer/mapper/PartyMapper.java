...
public interface PartyMapper extends BaseMapper<Party> {
    @Select("select a.party_name,a.mobile_no,c.link_employee_id,a.create_time as consult_time, a.party_id,a.wx_nick,a.open_id, " +
            " b.house_mode,b.house_area,b.house_address," +
            " d.house_id,d.house_counselor_id,d.cust_name as customer_name ,d.cust_id,d.house_mode as counselor_house_mode,d.house_detail,d.mobile_no as counselor_mobile_no " +
